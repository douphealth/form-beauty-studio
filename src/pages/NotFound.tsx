...
const NotFound = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Page Not Found — ImageForge</title>
        <meta name="description" content="The page you're looking for doesn't exist. Head back to ImageForge to compress, convert, and optimize images privately in your browser." />
        <meta name="robots" content="noindex,follow" />
        <link rel="canonical" href="https://imagealchemy.app/404" />
        <meta property="og:title" content="Page Not Found — ImageForge" />
