...
const GUIDE_CARDS = [
  ...
  { path: "/learn/best-free-image-compression-tools", title: "The best free image compression tools", desc: "An honest comparison of TinyPNG, Squoosh, ImageForge and more on privacy, quality and limits." },
];
...
export const HUB_CONTENT: Record<string, ContentEntry> = {
  "/learn": {
    ...
    lede: "Practical, up-to-date guides on compressing, converting and delivering web images. Written by the makers of ImageForge, so everything here is tested against a real browser-based tool — not theory.",
    ...
    faqs: [
      ...
      { question: "Are these image optimization guides free?", answer: "Yes. Every guide is free to read, has no paywall, and requires no account. The ImageForge compression tool they accompany is also free and private." },
      ...
      { question: "Can I compress images using what I learn here?", answer: "Yes — the ImageForge tool is linked from every guide. It runs entirely in your browser, so nothing is uploaded, and it applies the exact techniques described in these guides." },
    ],
