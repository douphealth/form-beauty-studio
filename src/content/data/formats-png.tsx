...
export const FORMAT_CONTENT: Record<string, ContentEntry> = {
  "/formats/png": {
    ...
    sections: [
      ...
      { id: "oxipng", heading: "OxiPNG: the modern PNG optimizer", body: [P(<>OxiPNG is a Rust-based optimizer that tries multiple filter and compression strategies and keeps the smallest result — often <strong>15–40% smaller</strong> than a standard PNG export, with zero quality loss. ImageAlchemy uses it under the hood.</>)] },
    ...
    faqs: [
      ...
      { question: "What is OxiPNG?", answer: "OxiPNG is a modern PNG optimizer written in Rust. It tries multiple filter and zlib compression strategies per image and keeps the smallest result, achieving 15–40% reduction with no quality loss. ImageAlchemy uses it for its PNG output." },
