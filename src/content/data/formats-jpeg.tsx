...
export const FORMAT_CONTENT: Record<string, ContentEntry> = {
  "/formats/jpeg": {
    ...
    sections: [
      ...
      { id: "progressive-jpeg", heading: "Progressive JPEG", body: [P(<>Progressive JPEGs load in passes, showing a low-quality version quickly before refining. They're typically smaller than baseline JPEGs and perceived as faster. ImageAlchemy outputs progressive JPEG by default.</>)] },
      { id: "how-to-compress", heading: "How to compress a JPEG with ImageAlchemy", body: [P(<>1. Drop your JPEG files. 2. Keep <strong>JPEG</strong> as the output format. 3. Set quality (80 default) and max dimension. 4. Compress and download. Up to 200 images per batch, entirely on-device.</>)] },
    ],
    faqs: [
      { question: "How do I reduce the file size of a JPEG?", answer: "Re-compress it at quality 80 with a modern encoder (MozJPEG with progressive and trellis settings) and resize to the dimensions it's actually displayed at. That typically cuts a quality-100 JPEG by 40–60% with no visible difference. ImageAlchemy does all of this in the browser." },
      ...
      { question: "Can I compress JPEG files without uploading them?", answer: "Yes. ImageAlchemy runs MozJPEG-grade encoding locally in your browser via WebAssembly. Files never leave your device, no account is needed, and up to 200 images can be processed per batch." },
    ],
    related: [
