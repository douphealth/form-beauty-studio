...
export const TOOL_CONTENT: Record<string, ContentEntry> = {
  "/tools/image-resizer": {
    ...
    sections: [
      { id: "how-to-resize", heading: "How to resize images with ImageForge", body: [P(<>1. Drop your images or click to browse (up to 200 at once). 2. Under <strong>resize</strong>, pick a preset — 4K (3840px), 2K (2560px), Full HD (1920px), HD (1280px), Web (1920px WebP), Thumbnail (512px) — or set a custom max dimension. 3. Compress, then download individually or as a ZIP.</>)] },
      ...
      { id: "resize-vs-compress", heading: "Resize vs compress — you need both", body: [P(<>Resizing reduces pixel count; compression encodes those pixels more efficiently. Resizing a 4000px photo to 1920px removes 75% of pixels, then converting to WebP at quality 80 compresses what's left. ImageForge does both in one step.</>)] },
      { id: "privacy", heading: "Private by design", body: [P(<>Your images never leave your computer. ImageForge runs WebAssembly codecs locally — no uploads, no server storage, no tracking pixels, no account. Safe for confidential and client work.</>)] },
    ],
    faqs: [
      { question: "How do I resize an image without losing quality?", answer: "Downscale rather than upscale, keep the aspect ratio locked, and export to a modern format (WebP or AVIF) at quality 80. Downscaling preserves sharpness; enlarging always softens. ImageForge keeps aspect ratio automatically when you set a maximum dimension." },
      ...
      { question: "Can I resize multiple images at once?", answer: "Yes — ImageForge supports batch resizing of up to 200 images per session. Set the dimensions once, apply to the whole batch, and download everything as a single ZIP." },
      { question: "How do I resize a photo on mobile?", answer: "ImageForge works in mobile browsers — the interface is fully responsive. Tap to browse your camera roll, pick a preset or custom dimension, and the resizing happens on-device." },
