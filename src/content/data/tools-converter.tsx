...
export const TOOL_CONTENT: Record<string, ContentEntry> = {
  "/tools/image-converter": {
    ...
    faqs: [
      { question: "How do I convert a PNG to WebP?", answer: "Drop the file into ImageForge, select WebP as the output format, set quality and max dimension, then compress and download. Transparency is preserved automatically. Up to 200 images can be converted per batch, entirely in the browser." },
      ...
      { question: "Can I convert images in bulk?", answer: "Yes. ImageForge processes up to 200 images per batch, with per-image format and quality overrides if individual files need different settings. Download the results individually or as a single ZIP." },
